"""Compare SGD and Gaussian S-SAM on a quadratic 1D Poisson PINN."""
...
CONFIG = {
    ...
    "data": {
        "name": "polynomial_poisson_interval",
        "interior_points": 512,
        "boundary_points": 256,
        "evaluation_resolution": 201,
        "seed": 17,
    },
    "pinn": {
        "pde_weight": 1.0,
        ...
        "output_dir": "outputs/polynomial_poisson_pinn",
        "evaluation": {
...
def main() -> None:
    ...
    points = build_polynomial_poisson_points(reference_config)
    ...
    for algorithm, config in configs.items():
        ...
        results[algorithm] = train_polynomial_poisson_pinn(model, points, config)
        metrics[algorithm] = evaluate_polynomial_poisson_pinn(
            model,
            points,
